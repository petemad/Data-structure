...
// Explanation: swap 3 is useless as it makes a copy of a and b then after the end of the function they will be deleted so all edits is eliminated by the end od function and a,b stay in same arrangment ... so it is useless.  
